...
import loginImageone from "../.../../../Assets/images/login/doctor-login-img-1.png";
import loginImagetwo from "../.../../../Assets/images/login/docotor-login-img-2.png";
import googleSso from '../../Assets/images/login/google-sso.png';
import facebookSso from '../../Assets/images/login/facebook-sso.png';
        ...
        <div className="conatiner-wrappe max-w-[1000px] flex gap-20 ">
          <div className="left-section">
            <div className="left-section-wrapper">
              <div className="image-area flex max-w-[500px] gap-4">
                <div className="img-1 mb-16">
                  <img src={loginImageone} alt="" className="w-[100%]" />
                </div>
                <div className="img-2 mt-16">
